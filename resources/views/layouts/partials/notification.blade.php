...
@endphp
<li class="dropdown dropdown-notification nav-item load_notifications"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-primary badge-up notifications_count">{{ $total_unread ?? 0 }}</span></a>
